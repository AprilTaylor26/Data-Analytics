...
- Data Cleaning & Visualization (R).ipynb
R‑based version of the same workflow, demonstrating cross‑language proficiency and reproducibility.
Predictive Analytics
- Predictive Analytics (P).ipynb
Python implementation of predictive modeling, including data preparation, model training, evaluation metrics, and performance comparison.
- Predictive Analytics (R).ipynb
R implementation of the same predictive modeling process, reinforcing understanding of modeling concepts across tools.
Prescriptive Analytics
- Prescriptive Analytics (P).ipynb
Python notebook performing optimization, sensitivity analysis, and scenario evaluation.
...
- Predictive modeling (classification/regression depending on dataset)
- Evaluation metrics (accuracy, RMSE, MAE, confusion matrix, etc.)
- Prescriptive analytics and sensitivity analysis
...
- Communicate insights clearly through code and visualization
